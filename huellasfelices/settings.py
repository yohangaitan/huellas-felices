"""
Django settings for huellasfelices project.
...
SECRET_KEY = 'django-insecure-40^ynns)hn@$0&ke+a4))gxext-$h+ejs4#lx*#7pl^&=bzr68'
...
ROOT_URLCONF = 'huellasfelices.urls'
...
WSGI_APPLICATION = 'huellasfelices.wsgi.application'
